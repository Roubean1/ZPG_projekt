...
private:
    ...
    std::shared_ptr<BezierSplineMovement> bezierSplineMovement;
    std::vector<glm::vec3> splineControlPoints;
    bool splineDrawingMode = false;

    void toggleSplineDrawingMode();
    void addSplineControlPoint(const glm::vec3& worldPos);
